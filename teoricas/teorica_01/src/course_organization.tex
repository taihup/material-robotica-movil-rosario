\begin{frame}
	\frametitle{Canales de comunicación}
	\footnotesize
	\begin{itemize}
		\item Página: \href{https://dcc.fceia.unr.edu.ar/es/lcc/521k}{https://dcc.fceia.unr.edu.ar/es/lcc/521k}
		\item Zulip
		\item Comunidades
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	Correlativas:
	\begin{itemize}
		% \item Álgebra Lineal (la requiere métodos numéricos)
		\item Probabilidad y Estadística
		% \item Complementos de Matemática I (la requiere Estructura de Datos y Algoritmos II que es requerida por IIA)
		\item Métodos numéricos 
		%\item Estructura de Datos y Algoritmos II (la requiere Intro. Intel. Artificial)
