...
\begin{frame}
	...
	Máquina diferencial mecánica que utilizaba tarjetas perforadas para realizar cómputos. Aunque no construida en su momento fijo los cimientos para construir la computadora electrónica ENIAC durante la Segunda Guerra Mundial.
...
\begin{frame}
	...
	\begin{figure}[!h]
        ...
        \subfloat[]
        {
            \includegraphics[width=0.165\columnwidth]{./images/industrial_robot.png}
        }\\
        \subfloat[]
        {
        ...
        \subfloat[]
        {
            \includegraphics[width=0.24\columnwidth]{./images/weed_removal_robot.jpg}
        }
        \subfloat[]
        {
            \includegraphics[width=0.295\columnwidth]{./images/aqua.png}
        }
    \end{figure}
\end{frame}
