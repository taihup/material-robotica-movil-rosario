...
\begin{frame}
    ...
    \only<2>{
        \begin{figure}
            \includegraphics[width=0.7\columnwidth]{wheres_wall_e_poster_found.jpg}
        \end{figure}
    }
...
\begin{frame}
	...
	\note{La Mecatrónica tiene como objetivo el diseño y desarrollo de sistemas inteligentes y automatizados que puedan interactuar con el entorno y adaptarse a diferentes situaciones. Los sistemas mecatrónicos pueden incluir robots, pero también abarcan una amplia gama de productos y sistemas que no necesariamente son robots (como electrodomésticos, dispositivos médicos, etc).}	
	
	\note{La domótica se refiere a la automatización y control inteligente de los sistemas y aparatos del hogar para mejorar la calidad de vida, la eficiencia energética y la seguridad. La palabra domótica proviene de la unión de las palabras domus (hogar en latín) y robótica.}
...
\begin{frame}
    ...
    \begin{figure}
    	\subfloat[]
    	{
    		\includegraphics[width=0.25\columnwidth,valign=m]{rossums_universal_robots_poster.jpg}
    	}\hspace{1em}
    	\subfloat[]
    	{
   			\includegraphics[width=0.68\columnwidth,valign=m]{rossums_universal_robots_play.jpg}
    	}
    \end{figure}
...
\begin{frame}
    \frametitle{Laboratorio de Robótica del CIFASIS}
      
    \begin{itemize}
        %\item Ernesto Kofman (Investigador Principal)
        ...
        \item Franco Vallejos Vigier (Becario Doctoral)
    \end{itemize}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[xshift=-4.5cm,yshift=-2cm] at (current page.east) { \includegraphics[height=0.5\textheight]{./images/cifasis/team_2024.jpg}};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    Comentar líneas de investigación...
