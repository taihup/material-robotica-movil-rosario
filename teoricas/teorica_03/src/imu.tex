...
\begin{frame}
    ...
    \begin{center}
        \movie[autostart,loop,poster]{\includegraphics[width=0.5\columnwidth,valign=m]{./images/mechanical_gyroscope_angular_velocity.jpg}}{./videos/mechanical_gyroscope_angular_velocity.mp4}
        \hspace{1em}
