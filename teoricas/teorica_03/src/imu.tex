...
\begin{frame}
    ...
    \begin{block}{Rigidez en el espacio}
        \begin{itemize}
            ...
            \item La cantidad de rigidez que presenta el giróscopo es directamente proporcional a su velocidad de rotación (RPM) y su momento de inercia.
...
\begin{frame}
    ...
    Una persona que se mueve hacia el norte hacia el borde exterior de una plataforma giratoria debe aumentar el componente de velocidad hacia el oeste (flechas azules) para mantener un rumbo hacia el norte. La aceleración requerida es la aceleración de Coriolis.
