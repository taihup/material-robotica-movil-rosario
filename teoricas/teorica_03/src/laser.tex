\begin{frame}
    ...
    \begin{figure}[!h]
        ...
        \subfloat[]
        {
            \movie[autostart,loop,poster]{\includegraphics[width=0.20\columnwidth,valign=m]{./images/lidar_2d_video.jpg}}{./videos/lidar_2d.mp4}
        }
        \hspace{2em}
        \subfloat[]
        {
            \includegraphics[width=0.48\columnwidth,valign=m]{images/lidar_example.pdf}
        }
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}[!h]
        ...
        \subfloat[]
        {
        \includegraphics[width=0.4\columnwidth]{images/lidar_concept.pdf}
        }
        \subfloat[]
        {
        \includegraphics[width=0.2\columnwidth]{images/lidar.pdf}
        }
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[width=0.85\columnwidth]{images/lidar3d.png}
    \end{figure}
