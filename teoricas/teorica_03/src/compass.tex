...
\begin{frame}
    ...
    \scriptsize
    \begin{center}
        \movie[autostart,loop,poster]{\includegraphics[width=0.4\columnwidth]{./images/hall_effect_video.jpg}}{./videos/hall_effect.mp4}
...
\begin{frame}
    ...
    \note{Pioneer 10 es una sonda espacial estadounidense lanzada el 2 de marzo de 1972 siendo la primera sonda espacial en explorar el sistema solar exterior y la heliosfera. Además fue la primera sonda que atravesó con éxito el cinturón de asteroides y que llegó hasta el planeta Júpiter, el objetivo principal de su misión.
