...
\begin{frame}
    ...
    \end{block}
	\note{esta asunción no sucede en la realidad ya que puede haber objetos que sean menores que el tamaño de la celda.}
	
	Cada celda es una variable aleatoria binaria que modela se la celda está ocupada o libre.
