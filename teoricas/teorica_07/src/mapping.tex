\begin{frame}
	...
	Curso de Cyrill Stachniss: \url{https://youtu.be/v-Rm9TUG9LA} slides: \url{http://ais.informatik.uni-freiburg.de/teaching/ws12/mapping/pdf/slam11-gridmaps-4.pdf}
...
\begin{frame}
    \frametitle{Quadtree y Octree}
    \note{información extraída de https://youtu.be/v-Rm9TUG9LA}
    
    \TODO{Agregar Quadtree y Octree}
