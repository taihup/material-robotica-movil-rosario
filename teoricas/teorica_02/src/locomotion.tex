...
\begin{frame}
    ...
    Tipos de Locomoción:
   	...
   	\begin{figure}[!h]
        ...
        {
            \includegraphics[width=0.15\columnwidth]{./images/acm-r5h_snake_robot.jpg}
        }
   		\subfloat[]
   		{
       		\includegraphics[width=0.15\columnwidth]{images/hexapod_phantomX_mark_II.jpg}
   		}
		\subfloat[ASIMO de Honda]
   		{
   			\includegraphics[width=0.1\columnwidth]{images/asimo_robot.jpg}
   		}
		\subfloat[Robot desmalezador]
   		{
   			\includegraphics[width=0.15\columnwidth]{./images/weed_removal_robot.jpg}
   		}
  		\subfloat[Drone Amazon]
        {
            \includegraphics[width=0.15\columnwidth]{images/drone.jpg}
        }
  		\subfloat[Drone Amazon]
        {
        	\includegraphics[width=0.15\columnwidth]{images/wingtra_hybrid_aerial_robot.jpg}
        }
      	\subfloat[]
        {
            \includegraphics[width=0.15\columnwidth]{images/aqua.png}
        }
   	\end{figure}
