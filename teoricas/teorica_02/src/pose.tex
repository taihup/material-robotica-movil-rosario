...
\begin{frame}
    ...
    Cuando representamos una Rotación con ángulos de Euler se puede producir una situación similar al bloqueo de Cardan.
    ...
    \begin{itemize}
        ...
        \item Existe un eje sobre el que no se puede girar.
    \end{itemize}
