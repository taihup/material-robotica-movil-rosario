...
\begin{frame}
    ...
    \begin{block}{Ángulos de Tait-Bryann}
        Combinaciones de giros con Ángulos de Tait-Bryann (o ángulos de navegación): $xyz$ $xzy$, $yxz$, $yzx$, $zxy$ y $zyx$. Los ángulos Tait-Bryann se usan normalmente para definir la posición de aeronaves, satélites o embarcaciones. Los ángulos Tait-Bryann se aplican utilizando un sistema de coordenadas fijo (Rotaciones extrínsecas).
    \end{block}
    
    \begin{block}{Ángulos de Yaw-Pitch-Roll}
        Específicamente, la combinación $zyx$ de Ángulos de Tait-Bryann se denomina $Yaw$, $Pitch$ y $Roll$.
    \end{block}
    
    Matríz de Rotación resultante utilizando ángulos Yaw-Pitch-Roll:
    \scriptsize
    \begin{align*}
