...
\begin{frame}
    ...
    \begin{align*}
        ...
        \begin{bmatrix}
            0 & 0 & 1\\
            \sin \theta + \cos \theta \sin \gamma& -\sin \theta \cos \gamma + \cos \theta \cos \gamma& 0\\
            \cos \theta \cos \gamma + \sin \theta \sin \gamma & \cos \theta \sin \gamma + \sin \theta \cos \gamma & 0
        \end{bmatrix}\\
        &=
        \begin{bmatrix}
            0 & 0 & 1\\
            \sin(\theta + \gamma) & \cos(\theta + \gamma) & 0\\
            -\cos(\theta + \gamma) & \sin(\theta + \gamma)& 0
        \end{bmatrix}
    \end{align*}
