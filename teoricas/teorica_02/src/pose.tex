...
\begin{frame}
    \frametitle{Ejercicio: Rotación 2D de un punto}
    ...
    \begin{center}
        \begin{minipage}{0.4\linewidth}
            \only<1>{
                \includegraphics[width=\columnwidth]{rotation_2D_example_1.pdf}
            }
            \only<2->{
                \includegraphics[width=\columnwidth]{rotation_2D_example_2.pdf}
            }
        \end{minipage}
        \hspace{1em}
        \begin{minipage}{0.5\linewidth}
            \only<1>{
                \begin{equation*}
                    \toCoord{\point^{\prime}}{A} = \, ?
                \end{equation*}
            }
            \only<2>{
                \begin{equation*}
                    \toCoord{\point^{\prime}}{A} =  \toCoord{\begin{bmatrix}
                        0\\
                        1
                    \end{bmatrix}}{A}
                \end{equation*}
            ...
            \only<3>{
                \begin{equation*}
                    \toCoord{\point^{\prime}}{A} = \rotationCoord{A}{B} \toCoord{\point}{A}
                \end{equation*}
...
\begin{frame}
    ...
    \begin{center}
        \begin{minipage}{0.4\linewidth}
            \only<1>{
                \includegraphics[width=\columnwidth]{rotation_2D_axis_example_1.pdf}
            }
            \only<2>{
                \includegraphics[width=\columnwidth]{rotation_2D_axis_example_3.pdf}
            }
        \end{minipage}
        \hspace{1em}
        \begin{minipage}{0.5\linewidth}
...
\begin{frame}
    \frametitle{Ejercicio: Traslación 2D de un punto}

    \begin{center}
        \begin{minipage}{0.4\linewidth}
            \only<1>{
                \includegraphics[width=\columnwidth]{translation_2D_point_example_1.pdf}
            }
            \only<2->{
                \includegraphics[width=\columnwidth]{translation_2D_point_example_2.pdf}
            }
        \end{minipage}
        \hspace{1em}
        \begin{minipage}{0.5\linewidth}
            ...
            \only<3>{
                Observemos que,
                \begin{align*}
                    \toCoord{\point^{\prime}}{A} &= \toCoord{\point}{A} + \translationCoord{A}{B}\\
                    \toCoord{\begin{bmatrix}
                        1\\
                        0
                    \end{bmatrix}}{B} &=
...
\begin{frame}
    \frametitle{Traslación 2D: Representación de un punto en otro Sist. de Coord.}

    \begin{center}
        \begin{minipage}{0.4\linewidth}
            \only<1>{
                \includegraphics[width=\columnwidth]{translation_2D_coord_example_1.pdf}
            }
            \only<2->{
                \includegraphics[width=\columnwidth]{translation_2D_coord_example_2.pdf}
            }
        \end{minipage}
        \hspace{1em}
        \begin{minipage}{0.5\linewidth}
            ...
            \only<4>{
                \begin{align*}
                    ...
                    \toCoord{\point}{B} &= \toCoord{\origin}{B} - \translationCoord{A}{B}\\
                    %\toCoord{\point}{B} &= ( \toCoord{\point}{A} + \translationCoord{A}{B} ) - \translationCoord{A}{B} \\
                    \toCoord{\begin{bmatrix}
                        -1\\
                        0
                    \end{bmatrix}}{B} &=
                    \toCoord{\begin{bmatrix}
                        0\\
                        0
                    \end{bmatrix}}{B} + \translationCoord{B}{A}\\
