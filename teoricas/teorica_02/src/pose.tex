...
\begin{frame}
    \frametitle{Propiedades de matrices Rotación}
    \TODO{Agregar imagen y explicar mejor: Los vectores columnas de la matriz de Rotación muestran donde se encuentran posicionados los ejes x, y y z luego de aplicar la rotación}
