\begin{frame}
    ...
    \TODO{refactorear slides}
    \TODO{Mostrar que una misma rotación, traslación o transformación se puede interpretar de dos formas. Se la puede interpretar como a donde van a parar los ejes canonicos o se lee como transformar puntos de un sistema de coordenadas a otro.}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \begin{minipage}{0.4\linewidth}
            ...
            \only<2->{
                \includegraphics[width=\columnwidth]{rotation_2D_axis_example_2.pdf}
            }
        \end{minipage}
        \hspace{1em}
        \begin{minipage}{0.5\linewidth}
