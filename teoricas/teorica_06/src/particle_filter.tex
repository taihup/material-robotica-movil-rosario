...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \note{También, en el reesampling al elegir muestras con mayor peso y al no elegir muestras con poco peso estamos describiendo mejor la distribución ya que las partículas de poco peso no contribuyen mucho a la aproximación de la distribución de probabilidad, y permite hacer un uso mejor de la memoria de la computadora.}
