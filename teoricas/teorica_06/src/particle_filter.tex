...
\begin{frame}
    ...
    \begin{itemize}
        \item Podemos usar una distribución diferente $\pi$ para generar muestras de una distribución $f$ (para la cuál queremos realmente hacer el muestreo)
    ...
    \note{El Importance Sampling Principle nos dice que podemos usar una distribución proposal para generar muestras de una distribución target (para la cuál queremos realmente hacer el muestreo) compensando los errores que cometamos. Y los errores aquí significa la diferencia entre los valores de la curva roja y la curva azul. Para esto debemos poder evaluar la función proposal y la función target para la misma entrada, y calcular el peso w.}
