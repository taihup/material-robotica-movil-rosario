...
\begin{frame}
	\frametitle{Jacobianos del modelo de movimiento}
	\note{información extraida de https://youtu.be/PiCC-SxWlH8}
    \TODO{Por qué separamos el jacobiano en dos G y V?}
...
\begin{frame}
    ...
    \begin{figure}[!h]
        ...
        {
            \includegraphics[width=0.49\columnwidth]{./images/ekf_pose_prediction.pdf}
        }
        \subfloat[Corrección de medición]
        {
            \includegraphics[width=0.49\columnwidth]{./images/ekf_measurement_correction.pdf}
        }
    \end{figure}
...
\begin{frame}
	...
	\note{información extraida de https://youtu.be/PiCC-SxWlH8}
   	...
   	\begin{figure}[!h]
        ...
        {
            \includegraphics[width=0.49\columnwidth]{./images/ekf_measurement_prediction.pdf}
        }
        \subfloat[Corrección de medición]
        {
            \includegraphics[width=0.49\columnwidth]{./images/ekf_measurement_correction.pdf}
