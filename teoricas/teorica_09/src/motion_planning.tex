...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemizes}
            \item Eficiencia: Tiene que ser eficiente al lidiar con objetos imprevistos imprevistos (dinámicos). Tiene que ser capaz de hacer (\empph{Re-planning}). Ej: Una puerta cerrada o un objeto dinámico.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Generar rápidamente acciones en el caso de objetos imprevistos (\empph{Re-planning}). Ej: Una puerta cerrada o un objeto dinámico.
	\end{itemize}
