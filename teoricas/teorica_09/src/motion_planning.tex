...
\begin{frame}
    ...
    \begin{figure}[!h]
        \includegraphics[width=0.2\textwidth]{images/motion_planning_geometrical_example.pdf}
    \end{figure}

    \begin{figure}[!h]
        \includegraphics[width=0.2\textwidth]{images/motion_planning_cspace_example.pdf}
    \end{figure}
