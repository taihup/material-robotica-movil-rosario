...
\begin{frame}
	...
	\begin{figure}
		\subfloat[Problem]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/visibility_graph_problem.pdf}}
		}\hspace{1em}
		\subfloat[Visibility graph]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/visibility_graph.pdf}}
		}\hspace{1em}
		\subfloat[Camino más corto encontrado]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/visibility_graph_path.pdf}}
		}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		\subfloat[Problem]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/voronoi_diagram_problem.pdf}}
		}\hspace{1em}
		\subfloat[Visibility graph]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/voronoi_diagram.pdf}}
		}\hspace{1em}
		\subfloat[Camino más corto encontrado]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/voronoi_diagram_path.pdf}}
		}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		\subfloat[Problem]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/cell_decomposition_centroids.pdf}}
		}\hspace{1em}
		\subfloat[Visibility graph]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/cell_decomposition_adjacency_cells.pdf}}
		}\hspace{1em}
		\subfloat[Camino más corto encontrado]
		{
			\fbox{\includegraphics[width=0.2\textwidth]{images/cell_decomposition_path.pdf}}
		}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.3\textwidth]{images/rrt_construction1.pdf}}
		}\hspace{1em}
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.3\textwidth]{images/rrt_construction2.pdf}}
		}\\
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.3\textwidth]{images/rrt_construction3.pdf}}
		}\hspace{1em}
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.3\textwidth]{images/rrt_construction4.pdf}}
		}\\
	\end{figure}
\end{frame}
