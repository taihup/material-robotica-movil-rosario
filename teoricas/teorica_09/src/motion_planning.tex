...
\begin{frame}
    ...
    \note{Información extrída de Cyrill Stachniss - Robot Motion Planning using A*: https://youtu.be/HR1TNa8Lp7w}
...
\begin{frame}
    \frametitle{$\configurationSpace$-Space Discretization}
