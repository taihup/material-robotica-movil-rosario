\begin{frame}
	...
	\begin{itemize}
		...
		\item Martin Saska - ECI Slides 2015
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Aunque el problema de motion planning es definido en el mundo regular, vive en otro espacio: el {\bf Espacio de configuraciones}
...
\begin{frame}
	...
	en un gráfico.
	\begin{itemize}
		\item Los nodos del grafo representan la configuración admisible de
		el robot.
		\item Los bordes representan un camino factible (trayectoria) entre el
