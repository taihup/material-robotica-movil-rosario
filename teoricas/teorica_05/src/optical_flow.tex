...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.55\textwidth]{optical_flow/optical_flow_edges.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.55\textwidth]{optical_flow/optical_flow_textured_regions.pdf}
  \end{center}
