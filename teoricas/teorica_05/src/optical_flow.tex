...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.11\columnwidth]{./images/optical_flow/motion_field.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[!h]
    ...
    {
      \movie[showcontrols,autostart,loop,poster]{\includegraphics[valign=b,width=0.2\columnwidth]{./images/optical_flow/barberpole_video.jpg}}{videos/barberpole.mp4}
    }
    \hspace*{2em}
    \subfloat[Motion field]
    {
        \includegraphics[valign=b,width=0.11\columnwidth]{./images/optical_flow/barberpole_motion_field.pdf}
    }
    \hspace*{2em}
    \subfloat[Optical Flow]
    {
        \includegraphics[valign=b,width=0.11\columnwidth]{./images/optical_flow/barberpole_optical_flow.pdf}
    }
  \end{figure}
  \begin{itemize}
