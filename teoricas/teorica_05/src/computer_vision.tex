...
\begin{frame}
    \frametitle{Cámara estéreo: Rectificación }
    \footnotesize
    
    \TODO{agregar cámaras rectificadas}
   
\end{frame}

\begin{frame}
    \frametitle{Cámara estéreo: Triangulación }
    \footnotesize
    
    \TODO{agregar triangulación}
    
\end{frame}

\begin{frame}
    \frametitle{Cámara estéreo: Calculo de Disparidad }
    \footnotesize
    
    \TODO{agregar disparidad}
