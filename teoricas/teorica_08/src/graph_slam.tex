...
\begin{frame}
    ...
    \begin{block}{Factor-Graph}
        Un Factor-graph es un término matemático, un grafo bipartito (Nodos: Variables y Factores) representando la factorización de una función. Esto significa que podemos tomar una función por ejemplo $g(.)$ y descomponerla mediante el producto de funciones $f(.)$,
