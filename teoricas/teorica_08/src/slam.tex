...
\begin{frame}
    ...
    \note{Información extraída de https://youtu.be/CJE59i8oxIE?si=3RmiP3UM2ImEj-av}
...
\begin{frame}
    ...
    \TODO{Agregar BA por Cyrill Stachniss \url{https://youtu.be/sobyKHwgB0Y?si=EqmuOjWNwKBI9jqH} \url{https://youtu.be/LKDLcKrWOIU?si=InRBlf5Nmf7mGM9H}}
