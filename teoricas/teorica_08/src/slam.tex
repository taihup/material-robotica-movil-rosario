...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Podemos hacer como hicimos con el prior anterior, pero el problema es que es solo una \emph{soft constraint} y no es realmente un fix. Ya que puede suceder que otra constraint mueva a este nodo, y por tanto no podemos asegurar que tenga un valor fijo.
...
\begin{frame}
    ...
    \end{itemize}
 	...
 	\begin{figure}[!h]
    \includegraphics[width=0.25\textwidth]{pose_graph_relative_uncertainty.pdf}
    \end{figure}
