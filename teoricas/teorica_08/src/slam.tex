...
\begin{frame}
	...
	El vector estado es la concatenación de los nodos pose $\state = (\state_{1}^{\top} \state_{2}^{\top} \dots \state_{n}^{\top})$
...
\begin{frame}
	\frametitle{Gauss-Newton para la minimización del error}
	\note{Información extraída de https://youtu.be/uHbRKvD8TWg}
