...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{images/factor_graph_example.pdf}
    \end{figure}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Al igual que las redes de Bayes o redes de Markov, podemos utilizar los Factor-Graph para describir relaciones de independencia entre variables. Y podemos correr diferentes algoritmos sobre estos Factor-Graph para inferir información de una manera eficiente.
    \end{itemize}
