...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Una restricción/arista existe entre el nodo $x_{i}$ y $x_{j}$ si el robot se muede de $x_{i}$ a $x_{i+1}$
 ...
 \begin{figure}
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.3\textwidth]{pose_graph_loop_example.pdf}}
		}\hfill{}
		\subfloat[]
		{
			\fbox{\includegraphics[width=0.44\textwidth]{pose_graph_odometry_edge.pdf}}
		}
	\end{figure}
...
\begin{frame}
	...
	\note{Información extraída de https://youtu.be/uHbRKvD8TWg}
    \begin{itemize}
		\item Hay un interplay entre el front-end y el back-end
		\item El mapa ayuda a determinar las restricciones reduciendo el espacio de búsqueda
		\item El front-end se encarga de convertir las mediciones crudas de los sensores en restricciones en el grafo.
		\item El back-end se encarga de tomar las restricciones dadas por el front-end y optimizar el grafo.
	\end{itemize}
