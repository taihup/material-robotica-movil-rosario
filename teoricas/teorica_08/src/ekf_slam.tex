...
\begin{frame}
    ...
    \TODO{Agregar matriz mas detallada}
    \TODO{\url{http://ais.informatik.uni-freiburg.de/teaching/ws15/mapping/pdf/slam05-ekf-slam.pdf}}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            ...
            \underbrace{\begin{bNiceMatrix}[margin = 4pt]
                ...
                \sigma_{\map{1,x}x} & \sigma_{\map{1,x}y} & \sigma_{\map{1,x}\theta} & \Cdots & \sigma_{\map{n,x}x} & \sigma_{\map{n,x}y} \\
                \sigma_{\map{1,y}x} & \sigma_{\map{1,y}y} & \sigma_{\map{1,y}\theta} & \Cdots & \sigma_{\map{n,y}x} & \sigma_{\map{n,y}y} \\
                \sigma_{\map{1,x}\map{1,x}} & \sigma_{\map{1,x}\map{1,y}} & \Cdots & \sigma_{\map{1,x}\map{n,x}} & \sigma_{\map{1,x}\map{n,y}} \\
                \sigma_{\map{1,y}\map{1,x}} & \sigma_{\map{1,y}\map{1,y}} & \Cdots & \sigma_{\map{1,y}\map{n,x}} & \sigma_{\map{1,y}\map{n,y}} \\
                \vdots & \vdots & \ddots & \vdots & \vdots \\
                \sigma_{\map{n,x}\map{1,x}} & \sigma_{\map{n,x}\map{1,y}} & \Cdots & \sigma_{\map{n,x}\map{n,x}} & \sigma_{\map{n,x}\map{n,y}} \\
                \sigma_{\map{n,y}\map{1,x}} & \sigma_{\map{n,y}\map{1,y}} & \Cdots & \sigma_{\map{n,y}\map{n,x}} & \sigma_{\map{n,y}\map{n,y}}
