    ...
    \begin{itemize}
        ...
        \begin{equation*}
            \underbrace{\begin{bNiceMatrix}[margin = 4pt]
                ...
                \rectanglecolor{green!40}{4-1}{9-1}
                \Body
                x \\
                y \\
                \theta \\
            ...
            \underbrace{\begin{bNiceMatrix}[margin = 4pt]
                ...
                \sigma_{\map_{1,x}x} & \sigma_{\map_{1,x}y} & \sigma_{\map_{1,x}\theta} & \cdots & \sigma_{\map_{1,x}\map_{n,x}} & \sigma_{\map_{1,x}\map_{n,x}} \\
                \sigma_{\map_{1,y}x} & \sigma_{\map_{1,y}y} & \sigma_{\map_{1,y}\theta} & \cdots & \sigma_{\map_{1,x}\map_{n,y}} & \sigma_{\map_{1,x}\map_{n,y}} \\
                \vdots & \vdots & \vdots & \vdots & \vdots & \ddots & \vdots & \vdots \\
                \sigma_{\map_{n,x}x} & \sigma_{\map_{n,x}y} & \sigma_{\map_{n,x}\theta}  & \cdots &  \sigma_{\map_{n,x} \map_{n,x}} & \sigma_{\map_{n,x} \map_{n,y}} \\
                \sigma_{\map_{n,y}x} & \sigma_{\map_{n,y}y} & \sigma_{\map_{n,y}\theta}  & \cdots &  \sigma_{\map_{n,y} \map_{n,x}} & \sigma_{\map_{n,y} \map_{n,y}}
