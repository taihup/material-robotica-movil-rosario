...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item Si el sensor de odometría y el GNSS son perfecto, la transformación \lstinline[style=bash]{/map} mapa $\rightarrow$ \lstinline[style=bash]{/odom} tf será la identidad.
...
\begin{frame}[fragile]
    ...
    \scriptsize
	\begin{itemize}
        \item Tutorial: \url{https://docs.ros.org/en/humble/Tutorials/Intermediate/Tf2/Introduction-To-Tf2.html}
        \item Instalación
        \begin{lstlisting}[style=bash] 
sudo apt-get install ros-<distro>-turtle-tf2-py ros-<distro>-tf2-tools ros-humble-tf-transformations
        \end{lstlisting}
