...
\begin{frame}[fragile]
	...
	\TODO{Agergar código publicador subscriptor con listings}
    
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[firstline=59, lastline=77]{src/publisher\_member\_function.cpp}
        \end{column}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[firstline=79, lastline=108]{src/publisher\_member\_function.cpp}
        \end{column}
    \end{columns}
