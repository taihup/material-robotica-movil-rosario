...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cpp,firstline=1,lastline=23]{src/publisher_member_function.cpp}
        \end{column}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cpp,firstline=25,lastline=44]{src/publisher_member_function.cpp}
        \end{column}
    \end{columns}
...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cpp,firstline=1,lastline=15]{src/subscriber_member_function.cpp}
        \end{column}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cpp,firstline=16,lastline=31]{src/subscriber_member_function.cpp}
        \end{column}
    \end{columns}
...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cmake,firstline=1,lastline=15]{src/CMakeLists.txt}
        \end{column}
        \begin{column}{0.5\textwidth}
            \lstinputlisting[style=cmake,firstline=16,lastline=28]{src/CMakeLists.txt}
        \end{column}
    \end{columns}
