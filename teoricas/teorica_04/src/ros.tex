...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item La creación de paquetes en ROS 2 utiliza \lstinline|ament| como sistema de compilación y \lstinline|colcon| como herramienta de compilación.
...
\begin{frame}
    ...
    \TODO{rqt\_bag todavía no fue portado a ROS 2}
