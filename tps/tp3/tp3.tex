...
\section{Datos}
Utilizar el dataset EuRoC\footnote{\url{https://projects.asl.ethz.ch/datasets/doku.php?id=kmavvisualinertialdatasets}}. Debera convertir la secuencia de calibración a formato ROS2, para esto puede utilizar el software \lstinline{rosbags}\footnote{https://pypi.org/project/rosbags/}. Las rosbags del dataset por defecto no cuentan con los mensajes de \lstinline{camera_info} requeridos para rectificar las imágenes, rosbags con mensajes de \lstinline{camera_info} pueden ser descargados de \url{http://fs01.cifasis-conicet.gov.ar:90/~pire/datasets/euroc_rosbag2/MH_01_easy_with_camera_info/}. %El resto de las secuencias ya se encuentran en formato ROS2 y pueden ser descargadas de \url{https://docs.openvins.com/gs-datasets.html}
