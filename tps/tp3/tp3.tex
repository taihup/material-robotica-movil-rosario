...
\section{Calibración}
Antes de comenzar a trabajar con el dataset se debe realizar una calibración de los sensores. En este trabajo solo deben calibrar una cámara estéreo.
...
Una vez calibradas las cámaras, se pide desarrollar un programa que lea un par de imágenes estéreo cualquiera y realice los siguientes pasos:
...
\section{Feature Mapping con Localización Ground-truth}
...
\section{Dense Mapping con Localización Ground-truth}
