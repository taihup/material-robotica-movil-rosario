...
\end{lstlisting}
	...
	\item Utilizar el launch y el modelo world provisto por la cátedra  para lanzar la simulación pero sin un mapa y sin el sistema de localización. El launch provisto es una modificación del  archivo \lstinline{tb3_simulation_launch.py} donde se comentó el código relacionado a la localización (\lstinline{slam}) y al mapa (\lstinline{map}). El modelo world \lstinline{world_only.model} resulta de comentar el código relacionado al modelo del mundo a utilizar.
