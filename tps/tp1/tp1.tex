...
\ejercicio Para este ejercicio utilizaremos el dataset EuRoc\footnote{\url{https://www.research-collection.ethz.ch/entities/researchdata/bcaf173e-5dac-484b-bc37-faf97a594f1f}}.

Descargar el archivo \emph{ground-truth} (trayectoria real realizada por el robot) de las secuencias Machine Hall ubicado en \url{https://www.research-collection.ethz.ch/server/api/core/bitstreams/7b2419c1-62b5-4714-b7f8-485e5fe3e5fe/content}. Se utilizará la secuencia Machine Hall 01.
